...
CORS_ALLOWED_ORIGINS = [
    'http://localhost:8000',
    'http://localhost:3000',
    'https://django-airbnb-xpb0.onrender.com',
]
...
AWS_S3_ENDPOINT_URL = "https://rzjfusywfooxdatlzbgj.storage.supabase.co/storage/v1/s3"
...
ASGI_APPLICATION = 'django_airbnb.asgi.application'
